# Contributing to SecondSemester
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/SecondSemester
   # Navigate to the newly cloned directory
   cd SecondSemester
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/<project-username>/SecondSemester
   ```
